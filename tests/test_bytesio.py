...
from iotools.bytesio import decode_bytes, encode_bytes, read_bytes, write_bytes, load_bytes, save_bytes, help_bytes
...
def test_encode_bytes():
    for i in range(len(data)):
        ...
        assert ldata == data[i], "Error while encoding bytes file nbr {}".format(i)
