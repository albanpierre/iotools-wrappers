...
from iotools.txtio import decode_txt, encode_txt, read_txt, write_txt, load_txt, save_txt, help_txt
...
def test_encode_txt():
    for i in range(len(data)):
        ...
        assert ldata == data[i].encode("utf-8"), "Error while encoding txt file nbr {}".format(i)
